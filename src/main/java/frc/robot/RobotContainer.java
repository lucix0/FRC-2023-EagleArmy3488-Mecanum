...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        testRoutine1 = new TestOneAuto(paths);
        ...
        Robot.m_DriveSubsystem.setDefaultCommand(new DriveCmd(() -> driveController.getLeftY(),
    ...
    private void configureBindings() {
        ...
        new JoystickButton(driveController, XboxController.Button.kLeftStick.value)
            .onTrue(new SetOrientationCmd());
        
        // Operator.
        opRightTrigger.whileTrue(new GrabCmd());
        new JoystickButton(operatorController, XboxController.Button.kRightBumper.value)
            .onTrue(new FourBarActCmd());
    }

    public Command getAutonomousCommand() {
        Robot.m_DriveSubsystem.resetOdometry(new Pose2d());
